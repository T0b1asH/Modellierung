...
def erstelle_network(years, snapshots, df_netzlast, df_pv, df_wind):
...
def main():
    ...
    # Network erstellen
    network = erstelle_network(years, snapshots, df_netzlast_alle_jahre, df_pv_alle_jahre, df_wind_alle_jahre)
